...
### <a style="color:blue;"> L05: Criar Postagem  </a>

O quinto Léxico, na Tabela 7, faz o uso do seguinte requisito: O sistema deve permitir criar postagens no fórum.. (<a href="../Elicitação/introcpeccao.md/#tabela-1--requisitos-funcionais">RF05</a>).
...
|-----------------|-------|
| Classificação | Verbo |
| Noção | Tarefa realizada pelo usuário, quando ele quer criar uma postagem para o fórum. 
        O usuário clica no ícone para criar uma postagem e digita seu comentário a ser postado |
...
### <a style="color:blue;"> L06: Ler Postagem  </a>

O sexto Léxico, na Tabela 8, faz o uso do seguinte requisito: O sistema deve permitirler postagens e comentários de outros usuários. (<a href="../Elicitação/introcpeccao.md/#tabela-1--requisitos-funcionais">RF06</a>).
...
|-----------------|-------|
| Classificação | Verbo |
| Noção | Tarefa realizada pelo usuário, quando ele quer ler uma postagem ou comentários de uma postagem divulgada no fórum. 
        O usuário clica navega pelo feed do fórum
        Lê a postagem que ele quer, ou acessa a postagem para poder ler os comentários sobre aquele mesmo post |
...
### <a style="color:blue;"> L07: Atualizar Postagem  </a>

O sétimo Léxico, na Tabela 9, faz o uso do seguinte requisito: O sistema deve permitir atualizar suas próprias postagens. (<a href="../Elicitação/introcpeccao.md/#tabela-1--requisitos-funcionais">RF07</a>).
...
|-----------------|-------|
| Classificação | Verbo |
| Noção | Tarefa realizada pelo usuário, quando ele quer editar uma postagem ou comentário que ele mesmo publicou. 
        O usuário acessa a postagem que ele quer editar
        O usuário clica no ícone para edição e reescreve o texto que ele quer mudar
        O usuário posta a nova mensagem editada|
...
### <a style="color:blue;"> L08: Deletar Postagem  </a>

O oitavo Léxico, na Tabela 10, faz o uso do seguinte requisito: O sistema deve permitir deletar suas próprias postagens. (<a href="../Elicitação/introcpeccao.md/#tabela-1--requisitos-funcionais">RF08</a>).
...
|-----------------|-------|
| Classificação | Verbo |
| Noção | Tarefa realizada pelo usuário, quando ele quer deletar uma postagem ou comentário que ele mesmo publicou. 
        O usuário acessa a postagem que ele quer deletar
        O usuário clica no ícone para deletar a postagem
...
>SERRANO, Milene. Requisitos – Aula 10. 2017. Apresentação de slides. Disponível em: [https://aprender3.unb.br/pluginfile.php/3070928/mod_page/content/5/Arquitetura%20e%20Desenho%20de%20software%20-%20Aula%20Projeto-DSW%20-%20Profa.%20Milene.pdf](https://aprender3.unb.br/pluginfile.php/3070928/mod_page/content/5/Arquitetura%20e%20Desenho%20de%20software%20-%20Aula%20Projeto-DSW%20-%20Profa.%20Milene.pdf). Acesso em: 08 abr. 2025.

## *Referências Bibliográficas*

> <a id="REF1" href="#anchor_1">1.</a> SAYÃO, Miriam, CARVALHO, Gustavo. Construção do léxico de aplicações. Information and Human Language Technology, 4th Workshop, Ribeirão Preto, 2006. Disponível em: <http://www-di.inf.puc-rio.br/~julio/bnncap3.pdf/>. Acesso em: 08 abr. 2025.
...
| 1.0    | 08/04/2025 | Adição dos léxicos 4-8 | [João Lucas](https://github.com/jlucasiqueira)          |  [Rafael Pereira](https://github.com/rafgpereira)  |
